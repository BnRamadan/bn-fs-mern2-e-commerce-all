...
mongoose.connect('mongodb+srv://bnramadan:bnmanopro12TE66@cluster0.t56mh.mongodb.net/e-commerce');
...
// Creation get all product endpoint
...
app.get('/newcollections', async (req, res) => {
  ...
  console.log('New Collection Retrieved');
  res.send(newcollection);
});

// popular in women collection data endpoint
app.get('/popularinwomen', async (req, res) => {
  let products = await Product.find({ category: 'women' });
  let popular_in_women = products.slice(-4);
  console.log('Popular in women Retrieved');
